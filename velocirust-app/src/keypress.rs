...
use velocirust_core::mode::{Mode, Modes};
...
use crate::{
    command::{CommandExecuted, CommandKind, VelocirustCommand, velocirust_internal_commands},
...
pub struct KeyPressData {
    ...
    pub commands: Rc<IndexMap<String, VelocirustCommand>>,
    ...
    pub commands_without_keymap: Rc<Vec<VelocirustCommand>>,
}

impl KeyPressData {
    pub fn new(cx: Scope, config: &VelocirustConfig) -> Self {
        ...
        let mut keypress = Self {
            ...
            commands: Rc::new(velocirust_internal_commands()),
    ...
    pub fn update_keymaps(&mut self, config: &VelocirustConfig) {
