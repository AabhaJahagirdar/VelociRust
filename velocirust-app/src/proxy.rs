...
use velocirust_proxy::dispatch::Dispatcher;
use velocirust_rpc::{
...
impl CoreHandler for Proxy {
    fn handle_notification(&mut self, rpc: velocirust_rpc::core::CoreNotification) {
    ...
    fn handle_request(
        &mut self,
        _id: velocirust_rpc::RequestId,
        _rpc: velocirust_rpc::core::CoreRequest,
    ) {
    }
}
