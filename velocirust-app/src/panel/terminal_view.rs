...
use velocirust_rpc::terminal::TermId;

use super::kind::PanelKind;
use crate::{
    app::clickable_icon,
    command::{InternalCommand, VelocirustWorkbenchCommand},
...
fn terminal_tab_header(window_tab_data: Rc<WindowTabData>) -> impl View {
    ...
    stack((
        ...
        container(clickable_icon(
            || VelocirustIcons::ADD,
            move || {
                workbench_command.send(VelocirustWorkbenchCommand::NewTerminalTab);
            },
            || false,
            || false,
            || "New Terminal",
