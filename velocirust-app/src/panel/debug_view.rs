        ...
        RunDebugMode::Debug => container(stack((
            {
                let terminal = terminal.clone();
                clickable_icon(
                    || VelocirustIcons::DEBUG_CONTINUE,
                    move || {
            ...
            },
            {
                let terminal = terminal.clone();
                clickable_icon(
                    || VelocirustIcons::DEBUG_STEP_OVER,
                    move || {
            ...
            },
            {
                let terminal = terminal.clone();
                clickable_icon(
                    || VelocirustIcons::DEBUG_STEP_INTO,
                    move || {
            ...
            },
            {
                let terminal = terminal.clone();
                clickable_icon(
                    || VelocirustIcons::DEBUG_STEP_OUT,
                    move || {
                ...
                stack((
                    {
                        let svg_str = match (&p.mode, p.stopped) {
                            (RunDebugMode::Run, false) => VelocirustIcons::START,
                            (RunDebugMode::Run, true) => VelocirustIcons::RUN_ERRORS,
                            (RunDebugMode::Debug, false) => VelocirustIcons::DEBUG,
                            (RunDebugMode::Debug, true) => {
                                VelocirustIcons::DEBUG_DISCONNECT
                            }
                        };
                ...
                .style(move |s| {
                    ...
                    s.padding_vert(6.0)
                        ...
                        .apply_if(is_active(), |s| {
                            s.background(
                                config.color(VelocirustColor::PANEL_CURRENT_BACKGROUND),
                            )
                        })
                        .hover(|s| {
                    ...
                    stack((
                        svg(move || {
                            ...
                            let svg_str = match node.expanded {
                                true => VelocirustIcons::ITEM_OPENED,
                                false => VelocirustIcons::ITEM_CLOSED,
                            };
                        ...
                        s.items_center()
                            ...
                            .hover(|s| {
                                s.apply_if(reference > 0, |s| {
                                    s.background(
                                        config.get().color(
                                            VelocirustColor::PANEL_HOVERED_BACKGROUND,
                                        ),
                                    )
                                })
                            })
                ...
                .style(move |s| {
                    ...
                    s.padding_left(20.0)
                        ...
                        .apply_if(!has_source, |s| {
                            s.color(config.color(VelocirustColor::EDITOR_DIM))
                        })
                        .hover(|s| {
                            s.background(
                                config.color(VelocirustColor::PANEL_HOVERED_BACKGROUND),
