...
pub struct VelocirustColor {}

impl VelocirustColor {
    pub const LAPCE_WARN: &'static str = "velocirust.warn";
    pub const LAPCE_ERROR: &'static str = "velocirust.error";
    pub const LAPCE_DROPDOWN_SHADOW: &'static str = "velocirust.dropdown_shadow";
    pub const LAPCE_BORDER: &'static str = "velocirust.border";
    pub const LAPCE_SCROLL_BAR: &'static str = "velocirust.scroll_bar";

    pub const LAPCE_BUTTON_PRIMARY_BACKGROUND: &'static str =
        "velocirust.button.primary.background";
    pub const LAPCE_BUTTON_PRIMARY_FOREGROUND: &'static str =
        "velocirust.button.primary.foreground";

    pub const LAPCE_TAB_ACTIVE_BACKGROUND: &'static str =
        "velocirust.tab.active.background";
    pub const LAPCE_TAB_ACTIVE_FOREGROUND: &'static str =
        "velocirust.tab.active.foreground";
    pub const LAPCE_TAB_ACTIVE_UNDERLINE: &'static str =
        "velocirust.tab.active.underline";

    pub const LAPCE_TAB_INACTIVE_BACKGROUND: &'static str =
        "velocirust.tab.inactive.background";
    pub const LAPCE_TAB_INACTIVE_FOREGROUND: &'static str =
        "velocirust.tab.inactive.foreground";
    pub const LAPCE_TAB_INACTIVE_UNDERLINE: &'static str =
        "velocirust.tab.inactive.underline";

    pub const LAPCE_TAB_SEPARATOR: &'static str = "velocirust.tab.separator";

    pub const LAPCE_ICON_ACTIVE: &'static str = "velocirust.icon.active";
    pub const LAPCE_ICON_INACTIVE: &'static str = "velocirust.icon.inactive";

    pub const LAPCE_REMOTE_ICON: &'static str = "velocirust.remote.icon";
    pub const LAPCE_REMOTE_LOCAL: &'static str = "velocirust.remote.local";
    pub const LAPCE_REMOTE_CONNECTED: &'static str = "velocirust.remote.connected";
    pub const LAPCE_REMOTE_CONNECTING: &'static str = "velocirust.remote.connecting";
    pub const LAPCE_REMOTE_DISCONNECTED: &'static str = "velocirust.remote.disconnected";

    pub const LAPCE_PLUGIN_NAME: &'static str = "velocirust.plugin.name";
    pub const LAPCE_PLUGIN_DESCRIPTION: &'static str = "velocirust.plugin.description";
    pub const LAPCE_PLUGIN_AUTHOR: &'static str = "velocirust.plugin.author";
