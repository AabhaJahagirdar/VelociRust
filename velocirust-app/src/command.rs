...
pub enum CommandKind {
    Workbench(VelocirustWorkbenchCommand),
    Edit(EditCommand),
    Move(MoveCommand),
...
pub fn velocirust_internal_commands() -> IndexMap<String, VelocirustCommand> {
    let mut commands = IndexMap::new();

    for c in VelocirustWorkbenchCommand::iter() {
        let command = VelocirustCommand {
...
pub enum VelocirustWorkbenchCommand {
    ...
    #[strum(message = "About Velocirust")]
    ShowAbout,
    ...
    #[cfg(target_os = "macos")]
    #[strum(message = "Install Velocirust to PATH")]
    #[strum(serialize = "install_to_path")]
    InstallToPATH,

    #[cfg(target_os = "macos")]
    #[strum(message = "Uninstall Velocirust from PATH")]
