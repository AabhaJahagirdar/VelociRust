...
use crate::{language::VelocirustLanguage, style::SCOPES};

thread_local! {
    static HIGHLIGHT_CONFIGS: RefCell<HashMap<VelocirustLanguage, Result<Arc<HighlightConfiguration>, HighlightIssue>>> = Default::default();
}
