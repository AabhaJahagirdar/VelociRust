...
use velocirust_rpc::style::{LineStyle, Style};
...
/// indices into the LANGUAGES array.  See method `VelocirustLanguage::properties`.
///
...
/// `VelocirustLanguage` as they will be accessed using the enum variants as indices.
const LANGUAGES: &[SyntaxProperties] = &[
    // Undetected/unmatched fallback or just plain file
    SyntaxProperties {
        id: VelocirustLanguage::PlainText,
        indent: Indent::tab(),
        files: &[],
        extensions: &["txt"],
    ...
    SyntaxProperties {
        id: VelocirustLanguage::Beancount,
        indent: Indent::tab(),
        files: &[],
        extensions: &[],
        comment: comment_properties!(),
    ...
    SyntaxProperties {
        id: VelocirustLanguage::Dockerfile,
        indent: Indent::space(2),
    ...
    SyntaxProperties {
        id: VelocirustLanguage::Gitattributes,
        indent: Indent::tab(),
        files: &[],
        extensions: &[],
        comment: comment_properties!(),
    ...
    SyntaxProperties {
        id: VelocirustLanguage::GitCommit,
        indent: Indent::tab(),
        files: &[],
        extensions: &[],
        comment: comment_properties!(),
    ...
    SyntaxProperties {
        id: VelocirustLanguage::GitConfig,
        indent: Indent::tab(),
    ...
    SyntaxProperties {
        id: VelocirustLanguage::GitRebase,
        indent: Indent::tab(),
        files: &[],
        extensions: &[],
        comment: comment_properties!(),
    ...
    SyntaxProperties {
        id: VelocirustLanguage::GoTemplate,
        indent: Indent::tab(),
        files: &[],
        extensions: &[],
        comment: comment_properties!(),
    ...
    SyntaxProperties {
        id: VelocirustLanguage::Javascript,
        indent: Indent::space(2),
        files: &[],
    ...
    SyntaxProperties {
        id: VelocirustLanguage::KotlinBuildScript,
        indent: Indent::space(2),
        files: &[],
        extensions: &["kts"],
        comment: CommentProperties {
    ...
    SyntaxProperties {
        id: VelocirustLanguage::Markdown,
        indent: Indent::space(4),
        files: &[],
        extensions: &["md"],
        comment: comment_properties!(),
    ...
    SyntaxProperties {
        id: VelocirustLanguage::MarkdownInline,
        indent: Indent::space(4),
    ...
    SyntaxProperties {
        id: VelocirustLanguage::OcamlInterface,
        indent: Indent::space(2),
        files: &[],
        extensions: &["mli"],
        comment: comment_properties!("(*"),
    ...
    SyntaxProperties {
        id: VelocirustLanguage::PowerShell,
        indent: Indent::space(4),
        files: &[],
    ...
    SyntaxProperties {
        id: VelocirustLanguage::ProtoBuf,
        indent: Indent::space(2),
        files: &[],
        extensions: &["proto"],
        comment: comment_properties!("//"),
    ...
    SyntaxProperties {
        id: VelocirustLanguage::ShellScript,
        indent: Indent::space(2),
        files: &[],
        extensions: &["sh"],
        comment: comment_properties!("#"),
    ...
    SyntaxProperties {
        id: VelocirustLanguage::SshClientConfig,
        indent: Indent::tab(),
        files: &[],
        extensions: &[],
        comment: comment_properties!(),
    ...
    SyntaxProperties {
        id: VelocirustLanguage::Typescript,
        indent: Indent::space(4),
        files: &[],
...
impl VelocirustLanguage {
    ...
    pub fn from_path(path: &Path) -> VelocirustLanguage {
        Self::from_path_raw(path).unwrap_or(VelocirustLanguage::PlainText)
    }

    pub fn from_path_raw(path: &Path) -> Option<VelocirustLanguage> {
    ...
    pub fn from_name(name: &str) -> Option<VelocirustLanguage> {
        match VelocirustLanguage::from_str(name.to_lowercase().as_str()) {
            Ok(v) => Some(v),
            Err(e) => {
                event!(Level::DEBUG, "failed parsing `{name}` VelocirustLanguage: {e}");
                None
            }
        }
    }
    ...
    fn get_grammar(&self) -> Option<tree_sitter::Language> {
        ...
        if let Some(grammars_dir) = Directory::grammars_directory() {
            match self::load_grammar(&grammar_name, &grammar_fn_name, &grammars_dir)
            {
                ...
                Err(err) => {
                    if self != &VelocirustLanguage::PlainText {
...
mod tests {
    ...
    use super::VelocirustLanguage;

    #[test]
    fn test_language_from_path() {
        let l = VelocirustLanguage::from_path(&PathBuf::new().join("test.rs"));
        assert_eq!(l, VelocirustLanguage::Rust);
    }
}
