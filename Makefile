# This Makefile is intended *only* for building macOS binaries of Velocirust.
...
app: $(APP_NAME)-native ## Create a Velocirust.app
app-universal: $(APP_NAME)-universal ## Create a universal Velocirust.app
$(APP_NAME)-%: $(TARGET)-%
	...
	xattr -c $(APP_DIR)/$(APP_NAME)/Contents/Resources/velocirust.icns
...
dmg: $(DMG_NAME)-native ## Create a Velocirust.dmg
dmg-universal: $(DMG_NAME)-universal ## Create a universal Velocirust.dmg
$(DMG_NAME)-%: $(APP_NAME)-%
